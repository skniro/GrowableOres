...
public class GrowableOreCaneBlock extends Block implements Fertilizable {
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        if (blockState.isOf(this)) {
            ...
            if (blockState.isOf(Blocks.GRASS_BLOCK) || blockState.isOf(Blocks.DIRT) || blockState.isOf(Blocks.COARSE_DIRT) || blockState.isOf(Blocks.PODZOL) || blockState.isIn(BlockTags.SAND) || blockState.isOf(Blocks.RED_SAND) || blockState.isIn(GrowableBlockTags.GrowBlock)) {
