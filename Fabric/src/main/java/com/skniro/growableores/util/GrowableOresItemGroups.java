...
public class GrowableOresItemGroups {
    ...
    public static void gtceu_item() {
        ItemGroupEvents.modifyEntriesEvent(Growable_Ores_Group).register(content -> {
            ...
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteAlmandine_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteAndradite_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteBlue_Topaz_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteCinnabar_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteCoal_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteDiamond_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteEmerald_Cane);
            content.add(GrowableGregTechCEuModernOresBlocks.GTM_ExquisiteGreen_Sapphire_Cane);
