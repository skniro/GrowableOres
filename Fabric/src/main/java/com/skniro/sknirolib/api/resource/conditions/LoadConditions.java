...
public final class LoadConditions {
    ...
    @SafeVarargs
    public static <T> ILoadCondition tagsPopulated(RegistryKey<? extends Registry<T>> registry, TagKey<T>... tags) {
    ...
    @SafeVarargs
    public static <T> ILoadCondition registryContains(RegistryKey<T>... entries) {
        return new RegistryContainsResourceCondition(entries);
    }

    public static <T> ILoadCondition registryContains(RegistryKey<? extends Registry<T>> registry, Identifier... entries) {
