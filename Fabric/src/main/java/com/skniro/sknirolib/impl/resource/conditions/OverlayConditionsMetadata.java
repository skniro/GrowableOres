...
public record OverlayConditionsMetadata(List<Entry> overlays) {
	...
	public static final ResourceMetadataSerializer<OverlayConditionsMetadata> SERIALIZER = new ResourceMetadataSerializer<>(LoadConditions.OVERLAYS_KEY, CODEC);
	...
	public record Entry(String directory, ILoadCondition condition) {
		public static final Codec<Entry> CODEC = RecordCodecBuilder.create(instance -> instance.group(
				Codec.STRING.validate(Entry::validateDirectory).fieldOf("directory").forGetter(Entry::directory),
				ILoadCondition.CODEC.fieldOf("type").forGetter(Entry::condition)
