...
public record AndResourceCondition(List<ILoadCondition> conditions) implements ILoadCondition {
	public static final MapCodec<AndResourceCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
			ILoadCondition.CODEC.listOf().fieldOf("values").forGetter(AndResourceCondition::conditions)
