...
public class GrowableBiomesOPlentyOresBlocks {
    ...
    //Biomes O' Plenty
    public static final RegistryObject<Block>  BOP_Rose_Quartz_Chunk_Cane = registerBlock("bop_rose_quartz_chunk_cane",  () -> new GrowableOreCaneBlock(Block.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_GREEN).noCollission().randomTicks().strength(0.0F).sound(SoundType.GRASS)),ModCreativeModeTabs.Growable_Ores_Group);
