...
public class GrowableDraconicEvolutionOresBlocks {
    ...
    //Draconic Evolution
    public static final RegistryObject<Block> DE_Awakened_Draconium_Ingot_Cane =registerBlock("de_awakened_draconium_ingot_cane",  () -> new GrowableOreCaneBlock(Block.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_GREEN).noCollission().randomTicks().strength(0.0F).sound(SoundType.GRASS)),ModCreativeModeTabs.Growable_Ores_Group);
    public static final RegistryObject<Block> DE_Draconium_Ingot_Cane =registerBlock("de_draconium_ingot_cane",  () -> new GrowableOreCaneBlock(Block.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_GREEN).noCollission().randomTicks().strength(0.0F).sound(SoundType.GRASS)),ModCreativeModeTabs.Growable_Ores_Group);
