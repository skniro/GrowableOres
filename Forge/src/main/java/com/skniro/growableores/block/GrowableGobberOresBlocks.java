...
public class GrowableGobberOresBlocks {
    ...
    //Gobber
    public static final RegistryObject<Block>  Gobber_End_Gobber_Ingot_Cane = registerBlock("gobber_end_gobber_ingot_cane", () -> new GrowableOreCaneBlock(Block.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_GREEN).noCollission().randomTicks().strength(0.0F).sound(SoundType.GRASS)),ModCreativeModeTabs.Growable_Ores_Group);
    public static final RegistryObject<Block>  Gobber_Gobber_Ingot_Cane = registerBlock("gobber_gobber_ingot_cane", () -> new GrowableOreCaneBlock(Block.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_GREEN).noCollission().randomTicks().strength(0.0F).sound(SoundType.GRASS)),ModCreativeModeTabs.Growable_Ores_Group);
