...
public class GrowableOresClient {
    ...
    public static void onInitializeClient(FMLClientSetupEvent event) {
        ...
        //BetterNether
        RenderTypeLookup.setRenderLayer(GrowableOresBlocks.BN_Cincinnasite_Cane.get(), RenderType.cutout());
        RenderTypeLookup.setRenderLayer(GrowableOresBlocks.BN_Nether_Ruby_Cane.get(), RenderType.cutout());
    }
