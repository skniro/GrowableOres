...
public class DefaultResourceConditionTypes {
	...
	public static final ResourceConditionType<ItemExistResourceCondition> ITEM_EXISTS = createResourceConditionType("item_exists", ItemExistResourceCondition.CODEC);

	private static <T extends ILoadCondition> ResourceConditionType<T> createResourceConditionType(String name, MapCodec<T> codec) {
		return ResourceConditionType.create(Identifier.fromNamespaceAndPath("sknirolib", name), codec);
	}
}
