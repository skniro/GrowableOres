            ...
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(GrowableVanillaOresBlocks.Iron_Cane.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        if (ModList.get().isLoaded("gtceu") || GrowableOresConfig.All_Item_Mode) {
                            //GregTechCEu Modern
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Aluminium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Americium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Annealed_Copper_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Antimony_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Battery_Alloy_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Beryllium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Bismuth_Bronze_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Bismuth_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Black_Bronze_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Brass_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Bronze_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Chromium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Cobalt_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Cupronickel_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Darmstadtium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Duranium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Electrum_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Enriched_Naquadah_Trinium_Europium_Duranide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Epoxy_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Europium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Amethyst_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Apatite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Certus_Quartz_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Coke_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Glass_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Grossular_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Lapis_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Lazurite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Malachite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Monazite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Nether_Quartz_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Olivine_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Opal_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Pyrope_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Quartzite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Realgar_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Red_Garnet_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Rock_Salt_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Ruby_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Rutile_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Salt_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Sapphire_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Sodalite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Spessartine_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Uvarovite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Yellow_Garnet_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Almandine_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Andradite_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Blue_Topaz_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Cinnabar_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Coal_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Diamond_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Emerald_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Exquisite_Green_Sapphire_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Gallium_Arsenide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Gallium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Graphene_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Indium_Gallium_Phosphide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Indium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Indium_Tin_Barium_Titanium_Cuprate_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Iridium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Lead_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Magnalium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Magnesium_Diboride_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Magnetic_Iron_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Magnetic_Neodymium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Magnetic_Samarium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Manganese_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Manganese_Phosphide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Mercury_Barium_Calcium_Cuprate_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Molybdenum_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Naquadah_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Naquadria_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Neodymium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Neutronium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Nichrome_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Nickel_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Nickel_Zinc_Ferrite_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Niobium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Niobium_Nitride_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Niobium_Titanium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Osmiridium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Osmium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Palladium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Platinum_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Plutonium_241_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Plutonium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polybenzimidazole_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polycaprolactam_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polyethylene_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polyphenylene_Sulfide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polytetrafluoroethylene_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Polyvinyl_Chloride_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Raw_Rubber_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Reinforced_Epoxy_Resin_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Rhodium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Riched_Naquadah_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Rose_Gold_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Rubber_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Ruridit_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Ruthenium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Ruthenium_Trinium_Americium_Neutronate_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Samarium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Samarium_Iron_Arsenic_Oxide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Silicon_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Silicone_Rubber_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Silver_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Soldering_Alloy_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Stainless_Steel_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Steel_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Sterling_Silver_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Styrene_Butadiene_Rubber_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tantalum_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Thorium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tin_Alloy_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tin_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Titanium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Trinium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tritanium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tungsten_Carbide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Tungsten_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Ultimet_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Uranium_235_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Uranium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Uranium_Rhodium_Dinaquadide_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Uranium_Triplatinum_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Vanadium_Gallium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Vanadium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Wrought_Iron_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Yttrium_Barium_Cuprate_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Yttrium_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Zinc_Ingot_Cane.get());
                            pOutput.accept(GrowableGregTechCEuModernOresBlocks.gtceu_Invar_Ingot_Cane.get());
                        }
