...
public record NotResourceCondition(ILoadCondition condition) implements ILoadCondition {
	public static final MapCodec<NotResourceCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
			ILoadCondition.CODEC.fieldOf("value").forGetter(NotResourceCondition::condition)
